 ...
 * Generates:
 *   scripts/research/output/{id}/PLAN.md     — filled Distill Plan
 *   skills/{id}/research/triple-verify-log.md — blank verification log
 *   skills/{id}/research/README.md           — research archive index
 *   scripts/research/{id}-deep.ts            — optional persona-specific deep research script
 *
 * Usage:
 *   npx tsx scripts/research/persona-research.ts <persona-id> --type=HK_ENTREPRENEUR
 *   npx tsx scripts/research/persona-research.ts li-ka-shing --type=CHINESE_BUSINESS
 */
...
> Compiled ${today}. Research type: **${preset.type}**. See [scripts/research/distill_templates/README.md](../../scripts/research/distill_templates/README.md) for methodology.
...
- [ ] Run \`npx tsx scripts/research/pipeline.ts ${id} --type=${preset.type} --deep-research\`
- [ ] Fill in PLAN.md
...
---
*Generated by \`scripts/research/persona-research.ts\` on ${today}*
`;
}
...
> Adapted from \`scripts/research/distill_templates/TRIPLE_VERIFY.md\`.
...
> Adapted from \`scripts/research/distill_templates/VALIDATION_HARNESS.md\`.
 ...
 * Auto-generated by \`scripts/research/persona-research.ts\`.
 *
 * Usage:
 *   npx tsx scripts/research/${id}-deep.ts
 */
...
function scaffoldPersona(
  ...
  const outputDir = resolve(ROOT, "scripts/research/output", id);
  ...
  console.log(`📁 Created: scripts/research/output/${id}/`);
  ...
  console.log(`✅ Created: scripts/research/output/${id}/PLAN.md`);
  ...
  console.log(`✅ Created: scripts/research/output/${id}/triple-verify-log.md`);
  ...
  console.log(`✅ Created: scripts/research/output/${id}/validation-log.md`);
  ...
  console.log(`✅ Created: scripts/research/output/${id}/SKILL_TEMPLATE.md`);
  ...
  console.log(`✅ Created: scripts/research/${id}-deep.ts`);
...
function main() {
  ...
  if (!id) {
    console.error("Usage: npx tsx scripts/research/persona-research.ts <persona-id> [--type=TYPE] [--name='Full Name']");
    console.error("");
    console.error("Types:");
    ...
    console.error("  npx tsx scripts/research/persona-research.ts li-ka-shing --type=HK_ENTREPRENEUR --name='Li Ka-shing 李嘉誠'");
    console.error("  npx tsx scripts/research/persona-research.ts warren-buffett --type=WESTERN_INVESTOR --name='Warren Buffett'");
    console.error("  npx tsx scripts/research/persona-research.ts killa-xbt --type=TWITTER_CRYPTO --name='KillaXBT'");
    process.exit(1);
  }
  ...
  console.log(`  1. npx tsx scripts/research/pipeline.ts ${id} --type=${type} --deep-research`);
  console.log(`  2. Edit scripts/research/output/${id}/PLAN.md`);
  console.log(`  3. Run distillation → fill in triple-verify-log.md`);
  console.log(`  4. npx tsx scripts/research/run-validation.ts ${id}`);
