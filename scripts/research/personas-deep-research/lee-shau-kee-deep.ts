#!/usr/bin/env tsx
/**
 * lee-shau-kee-deep.ts
 *
 * Persona-specific deep research for Lee Shau-kee 李兆基 (HK_ENTREPRENEUR).
 ...
 *
 * Usage:
 *   npx tsx ../personas-deep-research/lee-shau-kee-deep.ts
 */
...
const OUT_DIR = "../../data";
const NAME = "Lee Shau-kee 李兆基";
const ID = "lee-shau-kee";
...
async function main() {
  ...
  try {
    const discResult = await discoverSources(NAME, "HK_ENTREPRENEUR", { maxQueries: 15 });
  ...
  const eraQueries = [
      {
        era: "1-Founding",
        topic: "Lee Shau-kee 李兆基 Hong Kong founding business origins real estate early career",
        recencyDays: 18250,
        limit: 12
      },
      {
        era: "2-Expansion",
        topic: "Lee Shau-kee 李兆基 expansion acquisitions listed company corporate governance",
        recencyDays: 10950,
        limit: 12
      },
      {
        era: "3-Modern",
        topic: "Lee Shau-kee 李兆基 recent investments succession philanthropy business philosophy",
        recencyDays: 3650,
        limit: 15
      }
  ];
  ...
  { category: "adversarial", query: "\"Lee Shau-kee 李兆基\" criticism OR scandal OR failure OR mistake OR lawsuit" },
  { category: "adversarial", query: "\"Lee Shau-kee 李兆基\" investigation OR SEC OR regulatory OR fraud OR accused" },
  { category: "decision-records", query: "\"Lee Shau-kee 李兆基\" acquisition OR investment OR key decision reasoning" }
  ];
