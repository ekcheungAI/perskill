...
> **Research type:** Politics, Business
> **Compiled:** 2026-01-15
...
|-----------|------:|-------|
| Mental models | 2 | From `personas.ts` |
| Decision heuristics | 3 | From `personas.ts` |
...
- [ ] Run `npx tsx scripts/research/3_validate/validation-runner.ts donald-trump`
