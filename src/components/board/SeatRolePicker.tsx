  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="text-[10px] text-gray-400 mt-0.5 leading-relaxed" style={{ fontFamily: "Inter, sans-serif" }}>
          {config.description}
        </p>
      </div>
    </button>
            ...
            >
              ...
              <div className="flex items-center gap-3 px-4 py-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[13px] font-semibold text-gray-900" style={{ fontFamily: "Inter, sans-serif" }}>
                    {persona.name}
                  </p>
              ...
              {open && (
                <div className="px-4 pb-4 pt-1 border-t border-gray-50">
                  <p className="text-[10px] text-gray-400 mb-2 uppercase tracking-wider" style={{ fontFamily: "Inter, sans-serif" }}>
                    Assign seat role
                  </p>
                  ...
                  {persona.honestBoundaries && persona.honestBoundaries.length > 0 && (
                    <div className="mt-3 p-2.5 bg-amber-50 rounded-lg border border-amber-100">
                      <p className="text-[10px] font-semibold text-amber-700 mb-1.5 flex items-center gap-1" style={{ fontFamily: "Inter, sans-serif" }}>
                        <Info size={10} />
                        Honest Boundaries (consider before assigning)
                      </p>
                      <div className="space-y-1">
                        {persona.honestBoundaries.slice(0, 2).map((b, i) => (
                          <p key={i} className="text-[10px] text-amber-700 leading-relaxed" style={{ fontFamily: "Inter, sans-serif" }}>
